...
import com.increff.pdf.model.OrderItemData;
...
public class PdfService {
    ...
    public static String convertToPDF(OrderData order) throws ApiException {
    ...
    public String createInvoice(OrderData order) throws ApiException {
        convertToPDF(order);
        return "";
    }
}
