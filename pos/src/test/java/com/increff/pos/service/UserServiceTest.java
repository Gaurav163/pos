...
public class UserServiceTest extends AbstractUnitTest {
    ...
    public void testCreate() throws ApiException {
        User user = testHelper.getUser("name", "email", "password", null);
    ...
    public void testCreateDuplicateEmail() throws ApiException {
        User user = testHelper.getUser("name", "email", "password", null);
        User user1 = testHelper.getUser("name2", "email", "passwordss", null);
        userService.create(user);
    ...
    public void testGetByParameter() {
        User user = testHelper.createUser("name", "email", "password", "operator");
